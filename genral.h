...
#define pn_forward_sw_bit PINB1

#define port_backward_sw PORTB
#define ddr_backward_sw DDRB
#define pn_backward_sw PINB
#define pn_backward_sw_bit PINB0

#define port_forward_limit_sw PORTB
#define ddr_forward_limit_sw DDRB
#define pn_forward_limit_sw PINB
#define pn_forward_limit_sw_bit PINB3

#define port_backward_limit_sw PORTC
#define ddr_backward_limit_sw DDRC
#define pn_backward_limit_sw PINC
#define pn_backward_limit_sw_bit PINC0
